            ...
            <!-- Upper Footer -->
                <main class="grid grid-3">
                    ...
                    <article class="about">
                        ...
                        <p>Chaitanya Bharathi Institute of Technology is governed by Indus 
                    ...
                    <article class="contact">
                        <ul>
                            ...
                            <li> <i class="fas fa-phone-alt"></i> <p>+91 987456321</p></li>
                            <li> <i class="fas fa-envelope"></i> <p>cbit@org.co.in</p></li>
                            <li> <i class="fas fa-map-marker-alt"></i> <p>Gandipet,Hyderabad -500075</p></li>
                ...
                <main class="deep-devs flex">
                    ...
                    <div class="">Designed & Developed with <i class="fas fa-heart clr-red"></i> By <a href="#">IT-1</a></div>
                </main>
            </section>
        `;
        })
        ...
        userFooter.forEach(element => {
            ...
            <!-- Upper Footer -->
                <main class="grid grid-3">
                    ...
                    <article class="about">
                        <h1 class="sm">about</h1>
                        <p>Chaitanya Bharathi Institute of Technology is governed by hyderabad
                        Global Educational & Welfare Society which was founded 
                        in 2003 by a group of industrialists and educationalists
                        who shared a vision of establishing centers of scientific
                        learning around the country.</p>
                    ...
                    <article class="quick-links">
                        <ul>
                            ...
                            <li><a href="https://github.com/rvutd/mit-canteen-site" target="_blank">Git Repository</a></li>
                            <li><a href="https://mitindore.co.in/" target="_blank">CBIT Hyderabad</a></li>
                        </ul>
                    </article>
                    <!-- Contact Details -->
                    <article class="contact">
                        <ul>
                            <h1 class="sm">Contact Information</h1>
                            <li> <i class="fas fa-phone-alt"></i> <p>+91-9874563210</p></li>
                            <li> <i class="fas fa-envelope"></i> <p>cbit@org.co.in</p></li>
                            <li> <i class="fas fa-map-marker-alt"></i> <p>Gandipet,Hyderabad - 500075</p></li>
                            <li> <i class="fas fa-globe-asia"></i> <p>For Professional Courses, Visit: www.altius.ac.in</p></li>
                        </ul>
